...
int main(void)
{
	...
	// Preparamos uma variavel para se tornar um vertex buffer object (VBO)
	unsigned int buffer;
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(float), positions, GL_STATIC_DRAW); // Coloca os dados dentro do VBO
